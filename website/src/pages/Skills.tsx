    ...
    return (
        <Window open={open} onClose={onClose}>
            <Section id={id} title={t("skills.title")}>
                <div className="flex flex-col gap-4 max-w-3xl w-full bg-black/20 rounded-2xl p-8 space-y-4 shadow-lg">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {section.tags.map((tag, j) => {
                                    ...
                                    return (
                                        <motion.div
                                            key={j}
                                            className="flex items-center gap-2 p-2 rounded-xl bg-black/20 transition-colors"
